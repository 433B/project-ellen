...
public class TimeBomb extends AbstractActor {
    ...
    public void activate() {
        if (!isOn) {
            ...
            setAnimation(new Animation("sprites/bomb_activated.png",
                16, 16,
                time / 6, Animation.PlayMode.LOOP_REVERSED));
        }
        if (isOn) {
            ...
            new ActionSequence<>(new Wait<>(time), new Invoke<>(this::setAnim),
    ...
    public void setAnim() {
        setAnimation(new Animation("sprites/small_explosion.png",
            16, 16,
            0.125f, Animation.PlayMode.ONCE));
    }
